...
[_LOWER] = LAYOUT(
  ...
  _______, KC_WH_L, KC_WH_D, KC_WH_U, KC_WH_R, _______,                         XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX,  KC_F11,  KC_F12,
  _______, _______, _______, _______, KC_LCTL, KC_LSFT,                         KC_LEFT,  KC_DOWN,    KC_UP, KC_RGHT, KC_PIPE, XXXXXXX,
...
//                         _______, _______, _______, _______, _______,       _______, _______, _______, _______, _______
  ...
  KC_ESC,      KC_1,       KC_2,      KC_3,      KC_4,     KC_5,                        KC_6,     KC_7,     KC_8,     KC_9,     KC_0,  KC_DEL,
  KC_GRV,   _______,    _______,   _______,   _______,  _______,                     _______,  _______,  _______,  _______,  KC_PSCR, _______,
  KC_TAB,KC_UNDERSCORE, KC_MINS,    KC_EQL,   KC_PLUS,  _______,                     KC_HOME,  KC_PGDN,  KC_PGUP,  KC_END,  XXXXXXX, _______,
